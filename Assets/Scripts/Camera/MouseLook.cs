...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class MouseLook
    {
        ...
        {
            float yRot = CrossPlatformInputManager.GetAxis("Mouse X") * XSensitivity * mouseSensitivity;
            float xRot = CrossPlatformInputManager.GetAxis("Mouse Y") * YSensitivity * mouseSensitivity;
